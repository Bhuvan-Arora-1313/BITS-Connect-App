...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  String? _hostel;
final List<String> _hostelOptions = ['Meera', 'Vyas', 'Gandhi', 'Krishna', 'Budh','Ram','Shankar','Malviya', 'Vishvakarma','Ashok','Rana Pratap','Shriniwas Ramanujan','Day Scholar','Other'];
  ...
  final List<String> _yearOptions = ['1', '2', '3', '4', '5'];
  ...
  void _loadProfileData() async {
    ...
    if (data != null) {
      ...
      _cgpaPublic = data['cgpaPublic'] ?? false;
      _selectedCourses = List<String>.from(data['enrolledCourses'] ?? []);
      _gender = data['gender'];
      _yearOfStudy = data['yearOfStudy'];
      _phoneController.text = data['phone'] ?? '';
      _hostel = data['hostel'];
      _clubsController.text = data['clubs'] ?? '';
      setState(() {});
    }
  }
        ...
        child: ListView(
          ...
          children: [
            ...
            _styledCard([
              ...
              _inputField("CGPA", _cgpaController, keyboardType: TextInputType.number),
              SwitchListTile(
                title: const Text("Make CGPA Public"),
                value: _cgpaPublic,
                onChanged: (val) => setState(() => _cgpaPublic = val),
              ),
              _inputField("Bio", _bioController, maxLines: 3),
            ]),

            const SizedBox(height: 20),
            _sectionTitle("Extra Info"),
            _styledCard([
              _dropdownField("Gender", _genderOptions, _gender, (val) => setState(() => _gender = val)),
              const SizedBox(height: 12),
              _dropdownField("Year of Study", _yearOptions, _yearOfStudy, (val) => setState(() => _yearOfStudy = val)),
              const SizedBox(height: 12),
              _inputField("Phone", _phoneController, keyboardType: TextInputType.phone),
              const SizedBox(height: 12),
              _dropdownField("Hostel", _hostelOptions, _hostel, (val) => setState(() => _hostel = val)),
              const SizedBox(height: 12),
              _inputField("Clubs", _clubsController),
            ]),
  ...
  Widget _styledCard(List<Widget> children) {
    return Card(
      elevation: 4,
  ...
  Widget _dropdownField(String label, List<String> options, String? selected, void Function(String?) onChanged) {
